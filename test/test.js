...
describe('<=, strict=false', function () {
  it('all dates <= 2019-09-22', function () {
    ...
    assert.deepStrictEqual(
      matches,
      ['2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2018-12-24', '2008-12-24', '2008-01-01..2010-01-01', '2008-08', 'C2', 'c15', 'C20', 'C21', '1507-01-01', '0350-01-01', '350-01-01', '350', '0350', '360 BC', '350 BCE', '340 bc', '340s', '0340s', '1500s', '0360s', '2010s', '2000s', '1988..2020', 'early 2019', 'mid 2019', 'late 2019', 'late 2018', 'late 1505', 'late 350', 'mid 2019', 'late 2019-09', 'late 2010s', 'early 2000s', 'early 2010s', 'early C21', 'early C16', 'late C4', 'late C3', '~2000', '~2000-12', '~2000-12-24', '~C21', '~C20..~C21']
    )
  })
...
describe('>=, strict=false', function () {
  ...
  it('all dates >= 2019', function () {
    ...
    assert.deepStrictEqual(
      matches,
      ['2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2020-12-24', 'C21', 'C22', '2010s', '2020s', '1988..2020', 'early 2019', 'mid 2019', 'late 2019', 'mid 2019', 'late 2019-09', 'late 2010s', 'early C21', '~C21', '~C20..~C21']
    )
  })
