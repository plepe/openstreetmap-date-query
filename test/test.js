...
describe('=, strict=true', function () {
  it('all dates in C21', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2018-12-24', '2020-12-24', '2008-12-24', '2008-01-01..2010-01-01', '2008-08', 'C21', '2010s', '2000s', '2020s', 'early 2019', 'mid 2019', 'late 2019', 'late 2018', 'late 2019-09' ],
      matches
    )
  })
  ...
  it('all dates in the 2010s', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2018-12-24', '2010s', 'early 2019', 'mid 2019', 'late 2019', 'late 2018', 'late 2019-09' ],
      matches
    )
  })
  ...
  it('all dates in the year 2019', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', 'early 2019', 'mid 2019', 'late 2019', 'late 2019-09' ],
      matches
    )
  })
...
describe('=, strict=false', function () {
  it('all dates in C21', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2018-12-24', '2020-12-24', '2008-12-24', '2008-01-01..2010-01-01', '2008-08', 'C21', '2010s', '2000s', '2020s', '1988..2020', 'early 2019', 'mid 2019', 'late 2019', 'late 2018', 'late 2019-09' ],
      matches
    )
  })
  ...
  it('all dates in the 2010s', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2018-12-24', '2008-01-01..2010-01-01', 'C21', '2010s', 'early 2019', 'mid 2019', 'late 2019', 'late 2018', 'late 2019-09' ],
      matches
    )
  })
  ...
  it('all dates in the year 2019', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-01..2019-09-21', '2019-07..2019-10', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', 'C21', '2010s', 'early 2019', 'mid 2019', 'late 2019', 'late 2019-09' ],
      matches
    )
  })
  ...
  it('all dates in month 2019-09', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-09', '2019-09-01..2019-09-21', '2019-09-21', '2019-09-22', 'C21', '2010s', 'late 2019', 'late 2019-09' ],
      matches
    )
  })
  ...
  it('all dates at date 2019-09-21', function () {
    ...
    assert.deepEqual(
      [ '2019', '2019-09', '2019-09-01..2019-09-21', '2019-09-21', 'C21', '2010s', 'late 2019', 'late 2019-09' ],
      matches
    )
  })
})
