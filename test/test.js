...
describe('osmDateQuery', function () {
  ...
  it('all dates before 2019-09-22', function () {
    ...
    let matches = testAll(regexp)
    assert.deepEqual(
      [ '2019-07', '2019-08', '2019-09-21', '2019-01-01', '2018-12-24', '2008-12-24', '2008-08', 'C2', 'C15', 'C20', '1507-01-01', '0350-01-01', '350-01-01', '350', '0350', '360 BC', '350 BC', '340 BC', '340s', '0340s', '1500s', '0360s', '2000s' ],
      matches
    )
  })
...
describe('<=', function () {
  it('all dates <= 2019-09-22', function () {
    ...
    let matches = testAll(regexp)
    assert.deepEqual(
      [ '2019-07', '2019-08', '2019-09-21', '2019-09-22', '2019-01-01', '2018-12-24', '2008-12-24', '2008-08', 'C2', 'C15', 'C20', '1507-01-01', '0350-01-01', '350-01-01', '350', '0350', '360 BC', '350 BC', '340 BC', '340s', '0340s', '1500s', '0360s', '2000s' ],
      matches
    )
  })
  ...
  it('all dates <= 2019-09', function () {
    ...
    let matches = testAll(regexp)
    assert.deepEqual(
      [ '2019-07', '2019-08', '2019-09', '2019-09-21', '2019-09-22', '2019-01-01', '2018-12-24', '2008-12-24', '2008-08', 'C2', 'C15', 'C20', '1507-01-01', '0350-01-01', '350-01-01', '350', '0350', '360 BC', '350 BC', '340 BC', '340s', '0340s', '1500s', '0360s', '2000s' ],
      matches
    )
  })
  ...
  it('all dates <= 2019', function () {
    ...
    let matches = testAll(regexp)
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2018-12-24', '2008-12-24', '2008-08', 'C2', 'C15', 'C20', '1507-01-01', '0350-01-01', '350-01-01', '350', '0350', '360 BC', '350 BC', '340 BC', '340s', '0340s', '1500s', '0360s', '2000s' ],
      matches
    )
  })
  ...
  it('all dates <= C21', function () {
    ...
    let matches = testAll(regexp)
    assert.deepEqual(
      [ '2019', '2019-07', '2019-08', '2019-09', '2019-09-21', '2019-09-22', '2019-01-01', '2019-12-24', '2018-12-24', '2020-12-24', '2008-12-24', '2008-08', 'C2', 'C15', 'C20', 'C21', '1507-01-01', '0350-01-01', '350-01-01', '350', '0350', '360 BC', '350 BC', '340 BC', '340s', '0340s', '1500s', '0360s', '2010s', '2000s', '2020s' ],
      matches
    )
  })
})
